...
require_relative '../../dms_server/server_config'
...
class TestLibAudio < Test::Unit::TestCase
  def test_lib_audio
    assert_equal LibAudio.play_audio(ServerConfig::AUDIO_MOTION_START), true
    assert_equal LibAudio.play_audio(ServerConfig::AUDIO_MOTION_STOP), true
  end
end
